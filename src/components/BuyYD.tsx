      ...
      <div className="space-y-4 bg-gray-800 p-4 rounded-lg bg-opacity-60 mt-5">
        <div className="flex items-center mb-4">
          ...
          <div className="ml-2 mt-5">
            <Button>
              <ConfettiButton
                className="flex items-center gap-2 px-4 rounded-full bg-primary-dark hover:bg-primary-light hover:text-black"
                confettiText="Bought!"
              >
                <span className="text-white hover:text-black">Buy</span>
              </ConfettiButton>
            </Button>
          </div>
        </div>
        <p className="text-sm text-gray-300 border-t border-gray-400 shadow-inner pt-2">
